 ...
 *
 * <p>Registers under the short name {@code "bson"}. Supports both binary
 * BSON files (.bson) and line-delimited Extended JSON files (.json) as
 * exported by MongoDB Atlas Data Federation.
 *
 * <p>Usage:
 * <pre>{@code
