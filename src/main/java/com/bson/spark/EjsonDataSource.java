 ...
 *
 * <p>Functionally identical to {@link BsonDataSource} — both read
 * BSON binary and line-delimited EJSON files. This alias exists
 * so callers can use the format name that matches their file type:
 * <pre>{@code
