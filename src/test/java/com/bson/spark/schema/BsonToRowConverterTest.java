...
class BsonToRowConverterTest {
  ...
  class RealFederationOutput {
    ...
    void convertsActualFederationDocument() {
      ...
      assertThat(row.getUTF8String(7))
          .isEqualTo(UTF8String.fromString("ce4d849e-3eee-580c-9d79-d67b3cb8030f"));
      ...
      assertThat(metaRow.getUTF8String(2))
          .isEqualTo(UTF8String.fromString("https://example.com/platform"));
      ...
      assertThat(securityRow.getUTF8String(0))
          .isEqualTo(UTF8String.fromString("https://example.com/access"));
    ...
    void handlesDocumentWithExtensionArray() {
      ...
      StructType schema =
          new StructType(
              new StructField[] {
                ...
                new StructField(
                    "extension",
                    DataTypes.createArrayType(extensionSchema, true),
                    true,
                    Metadata.empty()),
              });
      ...
      assertThat(ext.getUTF8String(0))
          .isEqualTo(UTF8String.fromString("2022-06-20T17:18:38.704967Z"));
    }
    ...
    void handlesSubjectArrayWithNestedReferences() {
      ...
      StructType schema =
          new StructType(
              new StructField[] {
                ...
                new StructField(
                    "subject",
                    DataTypes.createArrayType(subjectSchema, true),
                    true,
                    Metadata.empty()),
              });
      ...
      assertThat(subject.getUTF8String(2))
          .isEqualTo(UTF8String.fromString("Patient/6917646a-941d-5a75-b229-202eae005a99"));
  ...
  class EjsonTypeConversions {
    ...
    void convertsObjectId() {
      ...
      InternalRow row =
          new BsonToRowConverter(schema, defaultOptions()).convert(BsonDocument.parse(ejson));
    ...
    void convertsDecimal128ToDecimalType() {
      ...
      StructType schema =
          new StructType(
              new StructField[] {
                new StructField(
                    "amount", DataTypes.createDecimalType(10, 3), true, Metadata.empty()),
              });
    ...
    void convertsRegex() {
      String ejson =
          "{\"pattern\":{\"$regularExpression\":{\"pattern\":\"^abc\",\"options\":\"i\"}}}";
      StructType schema =
          new StructType(
              new StructField[] {
  ...
  class CorruptRecordHandling {
    ...
    void normalRowsHaveNullErrorColumn() {
      String ejson =
          "{\"_id\":{\"$oid\":\"507f1f77bcf86cd799439011\"},\"count\":{\"$numberInt\":\"5\"}}";
      StructType schema =
          new StructType(
              new StructField[] {
                new StructField("_id", DataTypes.StringType, false, Metadata.empty()),
  ...
  class DeepNesting {
    ...
    void handlesArrayOfArrays() {
      String ejson =
          "{\"matrix\":[[{\"$numberInt\":\"1\"},{\"$numberInt\":\"2\"}],[{\"$numberInt\":\"3\"}]]}";
      StructType schema =
          new StructType(
              new StructField[] {
                new StructField(
